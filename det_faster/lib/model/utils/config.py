...
__C.TRAIN.TRIM_HEIGHT = 720
__C.TRAIN.TRIM_WIDTH = 1280
...
__C.PIXEL_MEANS = np.array([[[103.939, 116.779, 123.680]]])
...
__C.ANCHOR_SCALES = [2, 4, 8, 16, 24, 48]
...
def cfg_from_file(filename):
  ...
  with open(filename, 'r') as f:
    yaml_cfg = edict(yaml.load(f,yaml.FullLoader))
